--
-- This script upgrades the database schema from version 4.0 to
-- version 5.0.
--
-- sqlite3 sqlite.db < upgrade-db_4.0-5.0.sql
--
...
INSERT INTO user_version_trap VALUES (
  CASE (select user_version from pragma_user_version())
    WHEN 40 THEN 1                          -- VER_FROM
    ELSE NULL
  END
);

--                                             VER_TO
.print Upgrading database to version 5.0
...
ALTER TABLE exif ADD COLUMN Exiv2Json TEXT NULL;

--
-- Set the target database version
--
PRAGMA user_version=50;                     -- VER_TO
