--
-- This script upgrades the database schema from version 3.0 to
-- version 4.0.
--
-- sqlite3 sqlite.db < upgrade-db_3.0-4.0.sql
--
...
INSERT INTO user_version_trap VALUES (
  CASE (select user_version from pragma_user_version())
    WHEN 30 THEN 1                          -- VER_FROM
    ELSE NULL
  END
);

--                                             VER_TO
.print Upgrading database to version 4.0
...
DROP INDEX ix_scansets_scan_file;
